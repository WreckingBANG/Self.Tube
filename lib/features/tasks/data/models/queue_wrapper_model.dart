...
class QueueWrapperModel {
  final List<QueueItemModel> data;
  final int pageSize;
  final int pageFrom;
  ...
  factory QueueWrapperModel.fromJson(Map<String, dynamic> json) {
    final paginate = json['paginate'] ?? {};

    return QueueWrapperModel(
      data: (json['data'] as List<dynamic>)
          .map((item) => QueueItemModel.fromJson(item))
          .toList(),
