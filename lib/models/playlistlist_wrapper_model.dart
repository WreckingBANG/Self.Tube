import 'playlistlist_model.dart';

class PlaylistListWrapperModel {
  final List<PlaylistListItemModel> data;
  final int pageSize;
  final int pageFrom;
  ...
  factory PlaylistListWrapperModel.fromJson(Map<String, dynamic> json) {
    final paginate = json['paginate'] ?? {};

    return PlaylistListWrapperModel(
      data: (json['data'] as List<dynamic>)
          .map((item) => PlaylistListItemModel.fromJson(item))
          .toList(),
