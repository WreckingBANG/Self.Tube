import 'channellist_model.dart';

class ChannelListWrapperModel {
  final List<ChannelListItemModel> data;
  final int pageSize;
  final int pageFrom;
  ...
  factory ChannelListWrapperModel.fromJson(Map<String, dynamic> json) {
    final paginate = json['paginate'] ?? {};

    return ChannelListWrapperModel(
      data: (json['data'] as List<dynamic>)
          .map((item) => ChannelListItemModel.fromJson(item))
          .toList(),
